...
const Nav = ({
	...
	return (
		<nav className="flex items-center sm:text-lg lg:text-xl bg-slate-800 mb-4 text-slate-200 py-4 justify-around ">
			{showSearch ? null : (
			...
			{!showSearch ? (
				<div className="flex justify-between items-center w-40 pr-3">
					{user.token ? (
						<>
